  ...
  return (
    <>
      <div className="flex flex-wrap items-center justify-center p-8 xm:justify-between sm:p-12 bg-gray0">
        ...
        <div className="flex flex-col items-center order-last mt-6 xm:mt-0 xm:order-first space-y-3">
		<a href="https://partnernetwork.ionos.it/partner/marwan.tourky?origin=PartnerBadge" rel="nofollow">
			<img src="https://images-2.partnerportal.ionos.it/items/96018c73-4144-48e7-91cd-74d1c9a88028/profiles/3cdbcdb6-396d-4e50-b823-f9a8ca65f58e/badges/normal_blue_eco" alt="IONOS - Partner ufficiale"/>
				 </a>
        </div>
        <div className="flex flex-col items-center xm:items-start">
          <span className="block mb-3 text-gray2 text-tiny">Information</span>
          <span className="block mb-1 text-sm text-gray2">Want to hire me?</span>
          <ul className="flex flex-col items-center xm:items-start">
            <li className="flex items-center sm:text-xl space-x-2">
              <FaEnvelope className="inline-block" />
              <a href="mailto:contact@marwant.me" target="_blank">
                contact@marwant.me
              </a>
            </li>
            {/* <li className='flex items-center sm:text-xl space-x-2'>
