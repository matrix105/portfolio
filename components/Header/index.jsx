			...
			<div>
				<ul className='flex space-x-6'>
					<li className='flex items-center text-xs space-x-2 text-gray2'>
						...
						<a className='text-lg hover:text-green-lighter' href='https://www.linkedin.com/in/marwantourky/' target='_blank'>
							LinkedIn
						</a>
					</li>
					<li className='flex items-center text-xs space-x-2 text-gray2'>
						<FaGithub className='inline-block text-lg text-white'/>
						<a className='text-lg hover:text-green-lighter' href='https://github.com/matrix105' target='_blank'>
							GitHub
						</a>
					</li>
				</ul>
